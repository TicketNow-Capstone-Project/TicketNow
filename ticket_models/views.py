...
def page_view(request, page_name):
    if page_name == "op1":
        ...
        return render(request, "ticket_models/all_trips.html", {"trips": trips})
    elif page_name == "menu":   
        return render(request, "ticket_models/menu.html")
    elif page_name == "op2":   
        tickets = Ticket_Table.objects.all()
        return render(request, "ticket_models/all_tickets.html", {"tickets": tickets})
    elif page_name == "op3":
        if request.method == "POST":
            ...
            form = TicketForm()
        return render(request, "ticket_models/create_tickets.html", {"form": form})
        ...
        return render(request, "ticket_models/create_trips.html", {"form": form})
